...
// updateIcon - toggle between play and pause icons
// If video is playing, then show pause icon
// If video is paused, then show play icon
function updateIcon() {
    if (video.paused) {
        play.innerHTML = '<i class="fas fa-play fa-3x"></i>'
    } else {
        play.innerHTML = '<i class="fas fa-pause fa-3x"></i>'
    }
};
...
// 4- Video Element - update to progressbar and timestamp
